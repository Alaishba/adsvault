...
const mockTermsSections: TermsSection[] = [
  {
    ...
    title: "مقدمة",
    content:
      "مرحبًا بكم في منصة Mulhem. تُحدد هذه الشروط والأحكام القواعد والأنظمة الخاصة باستخدام منصتنا. باستخدامك لهذا الموقع، فإنك توافق على الالتزام بهذه الشروط. إذا كنت لا توافق على أي جزء من هذه الشروط، يُرجى عدم استخدام المنصة. نحتفظ بالحق في تعديل هذه الشروط في أي وقت دون إشعار مسبق.",
    order_number: 1,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    content:
      'تُقدم المنصة والمحتوى المتاح عليها "كما هي" دون أي ضمانات صريحة أو ضمنية. لا نضمن دقة أو اكتمال أو موثوقية أي محتوى على المنصة. لن تكون Mulhem مسؤولة عن أي أضرار مباشرة أو غير مباشرة ناتجة عن استخدام المنصة. التحليلات والتوصيات المقدمة هي لأغراض إرشادية فقط ولا تُعتبر نصيحة مهنية ملزمة.',
    order_number: 5,
  },
  {
    id: "6",
    title: "التواصل",
    content:
      "إذا كانت لديك أي أسئلة أو استفسارات بشأن هذه الشروط والأحكام، يُرجى التواصل معنا عبر البريد الإلكتروني: support@mulhem.io أو من خلال نموذج التواصل المتاح في المنصة. نسعى للرد على جميع الاستفسارات خلال 48 ساعة عمل. مقرنا الرئيسي في منطقة الشرق الأوسط وشمال أفريقيا ونخدم العملاء في جميع أنحاء المنطقة.",
    order_number: 6,
  },
];
