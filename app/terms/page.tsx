...
const defaultSections = [
  { title: "مقدمة", content: `منصة Mulhem هي خدمة B2B متخصصة في تحليل الإعلانات الرقمية لمنطقة الشرق الأوسط وشمال أفريقيا. باستخدام هذه المنصة، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على هذه الشروط، يرجى التوقف عن استخدام المنصة فوراً.` },
  ...
  { title: "حقوق الملكية الفكرية", content: `جميع الإعلانات المعروضة على المنصة مستخدمة لأغراض التحليل والدراسة وفق مبدأ الاستخدام العادل. المحتوى التحليلي والاستراتيجيات المنشورة على Mulhem هي ملكية فكرية للمنصة.` },
  { title: "إخلاء المسؤولية", content: `المعلومات المقدمة على المنصة هي لأغراض تعليمية وتحليلية فقط. لا تضمن Mulhem دقة أو اكتمال جميع البيانات المعروضة.` },
  { title: "التواصل", content: `لأي استفسارات قانونية أو شكاوى:\nالبريد الإلكتروني: legal@mulhem.com\nالعنوان: دبي، الإمارات العربية المتحدة\nساعات العمل: الأحد - الخميس، 9 صباحاً - 6 مساءً` },
];
