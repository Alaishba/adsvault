    ...
    <AppLayout>
      <div className="px-6 lg:px-10 py-8 max-w-2xl">
        ...
        <div className="mt-4 p-4 rounded-xl border border-[--border] text-sm" style={{ color: "var(--text-secondary)" }}>
          <strong style={{ color: "var(--text-primary)" }}>ملاحظة:</strong> سيتم مراجعة جميع الطلبات خلال 3-5 أيام عمل. في الحالات الطارئة، يمكنك التواصل مباشرة على: legal@advaultmena.com
        </div>
      </div>
    </AppLayout>
  );
